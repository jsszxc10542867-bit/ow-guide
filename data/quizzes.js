...
const quizAnswers = [
  ...
  { correct: 0, cat:'advanced',    topic:'cdTrack',  message: "정답! 생존기가 빠진 10초가 들어갈 타이밍입니다. \"수주 빠졌어요\" 콜과 함께 진입하세요." },
  ...
  { correct: 2, cat:'heroes',      topic:'healLos',  message: "정답! 부활하다 죽으면 2명 손해입니다. 안전할 때만 쓰세요." }
];
...
const QUIZ_EXPLAIN = [
  ...
  '뭉쳐 있으면 광역 궁(자탄·타이어)의 표적이 됩니다. 적당히 분산하고 엄폐물 옆에.',
  ...
  '수주가 빠진 14초는 상대에게 CC 해제·무적이 없는 시간입니다. 지금이 진입 타이밍입니다.',
  ...
  '부활는 안전할 때만. 적 앞에서 부활하면 둘 다 죽어 2명 손해입니다.'
];
